...
```
@source(type="email", username="<STRING>", password="<STRING>", store="<STRING>", host="<STRING>", search.term="<STRING>", polling.interval="<STRING>", action.after.processed="<STRING>", folder.to.move="<STRING>", content.type="<STRING>", ssl.enable="<STRING>", @map(...)))
```
...
<table>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">user name of the email account</td>
    ...
    <tr>
        ...
        <td style="vertical-align: top">imap.gmail.com</td>
        <td style="vertical-align: top">STRING</td>
        <td style="vertical-align: top">Yes</td>
        <td style="vertical-align: top">No</td>
    </tr>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">Interval that email source should poll the account to check for new mails arrivals </td>
        <td style="vertical-align: top">600000</td>
        <td style="vertical-align: top">STRING</td>
        <td style="vertical-align: top">Yes</td>
        <td style="vertical-align: top">No</td>
    </tr>
...
<table>
    ...
    <tr>
        <td style="vertical-align: top">mail.imap.port</td>
        <td style="vertical-align: top; word-wrap: break-word">The IMAP server port to connect to, if the connect() method doesn't explicitly specify one.</td>
...
```
@source(type='email', @map(type='xml'), username='wso2@gmail.com', password='wso234',store = 'imap',host = 'imap.gmail.com ,searchTerm = 'subject:das, from: wso2one@ , cc: wso2two, polling.interval='50000',action.after.processed='SEEN',content.type='text/html,)define stream inputStream (name string, age int, country string);
```
...
```
@sink(type="email", username="<STRING>", password="<STRING>", store="<STRING>", host="<STRING>", ssl.enable="<STRING>", auth="<STRING>", content.type="<STRING>", subject="<STRING>", to="<STRING>", cc="<STRING>", bcc="<STRING>", @map(...)))
```
...
<table>
    ...
    <tr>
        <td style="vertical-align: top">username</td>
        <td style="vertical-align: top; word-wrap: break-word">Username(address) of the email account which is used to send emails.</td>
        <td style="vertical-align: top"></td>
        <td style="vertical-align: top">STRING</td>
        <td style="vertical-align: top">No</td>
        <td style="vertical-align: top">No</td>
    ...
    <tr>
        <td style="vertical-align: top">store</td>
        <td style="vertical-align: top; word-wrap: break-word">Type of the store which is used to receive mails. It can be either imap ,pop3 , imaps or pop3s.</td>
        <td style="vertical-align: top">imap</td>
        <td style="vertical-align: top">STRING</td>
        <td style="vertical-align: top">Yes</td>
        <td style="vertical-align: top">No</td>
...
<table>
    ...
    <tr>
        <td style="vertical-align: top">mail.smtp.port</td>
        <td style="vertical-align: top; word-wrap: break-word">The SMTP server port to establish the connection.</td>
...
```
@sink(type='email', @map(type='json'), username='wso2@gmail.com', password='abc123',store='imap'host='smtp.gmail.com',subject='Event from SP',to='wso2one@gmail.com ,wso2two@gmail.com',cc='wso2three@gmail.com)define stream inputStream (name string, age int, country string);
```
